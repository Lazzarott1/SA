...
O SCRUM faz parte das metodologias ágeis e segue os princípios do Manifesto Ágil, valorizando:
colaboração entre equipes; adaptação às mudanças; comunicação constante; entregas rápidas e contínuas; foco no cliente.
Diferente dos métodos tradicionais, em que todo o projeto é planejado no início e entregue apenas no final, o SCRUM trabalha de forma incremental, ou seja, pequenas partes do sistema são entregues ao longo do desenvolvimento.

Objetivo da metodologia SCRUM

O principal objetivo do SCRUM é:
Desenvolver produtos de forma mais rápida, organizada e eficiente.

Além disso, a metodologia busca:
melhorar a produtividade da equipe;
reduzir erros e retrabalho;
facilitar mudanças durante o projeto;
aumentar a qualidade do software;
entregar valor continuamente ao cliente;
melhorar a comunicação entre os membros da equipe;
acompanhar constantemente o progresso do projeto.

Com SCRUM, o cliente pode acompanhar o desenvolvimento do sistema em tempo real e sugerir mudanças durante o processo.
Principais papéis do SCRUM
...
2 semanas;
até 1 mês.
Durante a Sprint, a equipe desenvolve uma parte do sistema.
Objetivo da Sprint
Entregar uma versão funcional do produto ao final do período.
...
quais tarefas terão prioridade;
...
Objetivo
Acompanhar o progresso do trabalho e identificar problemas.
